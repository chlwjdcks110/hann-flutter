          ...
          child: Column(
            children: [
              ...
              Expanded(child: Container(
                ...
                child:  ListView(
                  children: [
                    Text("2023-11-01 16:57 감기약 선빈약국",style: TextStyle(fontSize: 20.0,),),
                    Text("2023-11-01 16:57 두통약 영훈약국",style: TextStyle(fontSize: 20.0,),),
                    Text("2023-11-01 16:57 설사약 정찬약국",style: TextStyle(fontSize: 20.0,),),
                    Text("2023-11-01 16:57 혈압약 재윤약국",style: TextStyle(fontSize: 20.0,),),
